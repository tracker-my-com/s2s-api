...
/**
 * @coversDefaultClass \Mycom\Tracker\S2S\Api\GooglePlayProductTransactionBatchMethod
 */
class GooglePlayProductTransactionBatchMethodTest extends TestCase
{
    ...
    public function testValidateEmptyBatchError(): void
    {
        ...
        $method = new GooglePlayProductTransactionBatchMethod($credential, 1);
