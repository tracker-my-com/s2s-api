...
/**
 * @coversDefaultClass \Mycom\Tracker\S2S\Api\AppStoreSubscriptionTransactionBatchMethod
 */
class AppStoreSubscriptionTransactionBatchMethodTest extends TestCase
{
    ...
    public function testValidateEmptyBatchError(): void
    {
        ...
        $method = new AppStoreSubscriptionTransactionBatchMethod($credential, 1);
