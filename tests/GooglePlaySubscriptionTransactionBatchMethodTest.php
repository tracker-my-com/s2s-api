...
/**
 * @coversDefaultClass \Mycom\Tracker\S2S\Api\GooglePlaySubscriptionTransactionBatchMethod
 */
class GooglePlaySubscriptionTransactionBatchMethodTest extends TestCase
{
    ...
    public function testValidateEmptyBatchError(): void
    {
        ...
        $method = new GooglePlaySubscriptionTransactionBatchMethod($credential, 1);
