...
/**
 * @coversDefaultClass \Mycom\Tracker\S2S\Api\CustomRevenueBatchMethod
 */
class CustomRevenueBatchMethodTest extends TestCase
{
    ...
    public function testValidateEmptyBatchError(): void
    {
        ...
        $method = new CustomRevenueBatchMethod($credential, 1);
