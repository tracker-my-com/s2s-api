...
/**
 * @coversDefaultClass \Mycom\Tracker\S2S\Api\GooglePlaySubscriptionTokenBatchMethod
 */
class GooglePlaySubscriptionTokenBatchMethodTest extends TestCase
{
    ...
    public function testValidateEmptyBatchError(): void
    {
        ...
        $method = new GooglePlaySubscriptionTokenBatchMethod($credential, 1);
