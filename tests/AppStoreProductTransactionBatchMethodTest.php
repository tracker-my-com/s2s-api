...
/**
 * @coversDefaultClass \Mycom\Tracker\S2S\Api\AppStoreProductTransactionBatchMethod
 */
class AppStoreProductTransactionBatchMethodTest extends TestCase
{
    ...
    public function testValidateEmptyBatchError(): void
    {
        ...
        $method = new AppStoreProductTransactionBatchMethod($credential, 1);
