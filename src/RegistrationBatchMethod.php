...
/**
 * Registration batch method implementation
 */
final class RegistrationBatchMethod extends Method
{
    /** @var string Registration batch method name */
    private const URI = 'registrationBatch';
    ...
    /**
     * RegistrationBatchMethod constructor.
     *
