...
/**
 * App store product subscription batch command implementation
 */
final class AppStoreSubscriptionTransactionBatchMethod extends BatchMethod
{
    /** @var string method name */
    private const URI = 'appStoreSubscriptionTransactionBatch';
